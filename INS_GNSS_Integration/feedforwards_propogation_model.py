...
def feedforwards_propogation_model(x_prior, w_i_b, f_bt, dt):
    # Implements the propagation model with feedforward arch.
    # Inputs:
    #     x_prior (np.ndarray): A 12x1 numpy array representing the prior state.
    ...
    #     dt (float): Time step.
    # Outputs:
    #     (np.ndarray): A 12x1 numpy array representing the updated state.
